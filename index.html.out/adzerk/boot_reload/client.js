...
var len__6061__auto___6892 = arguments.length;
var i__6062__auto___6893 = (0);
while(true){
if((i__6062__auto___6893 < len__6061__auto___6892)){
args__6068__auto__.push((arguments[i__6062__auto___6893]));

var G__6894 = (i__6062__auto___6893 + (1));
i__6062__auto___6893 = G__6894;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__6890){
var vec__6891 = p__6890;
var opts = cljs.core.nth.call(null,vec__6891,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__6891,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__6891,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__6891,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__6891,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq6888){
var G__6889 = cljs.core.first.call(null,seq6888);
var seq6888__$1 = cljs.core.next.call(null,seq6888);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__6889,seq6888__$1);
});
